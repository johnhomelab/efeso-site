    ...
    <div className="min-h-screen bg-[#0f0f10] text-zinc-100 selection:bg-[#c6a661]/30">
      ...
      <header className="sticky top-0 z-50 backdrop-blur supports-[backdrop-filter]:bg-black/40 border-b border-white/5">
        <div className="mx-auto max-w-7xl px-6 py-4 flex items-center justify-between">
          ...
          <a href={whatsapp} target="_blank" rel="noopener noreferrer" aria-label="Falar no WhatsApp" className="inline-flex items-center gap-2 rounded-2xl bg-[#c6a661] px-4 py-2 text-[#1e1e1e] font-medium shadow-[0_10px_30px_rgba(198,166,97,0.35)] hover:brightness-110">
            Falar no WhatsApp
          </a>
        </div>
      </header>
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 md:py-28 grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <a href={whatsapp} target="_blank" rel="noopener noreferrer" className="rounded-2xl bg-[#c6a661] px-6 py-3 text-[#1e1e1e] font-semibold hover:brightness-110 shadow-[0_10px_30px_rgba(198,166,97,0.35)]">Solicitar diagnóstico gratuito</a>
      ...
      <footer id="contact" className="border-t border-white/5">
        <div className="mx-auto max-w-7xl px-6 py-14 grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="flex md:justify-end">
            <a href={whatsapp} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-2xl bg-[#c6a661] px-6 py-3 text-[#1e1e1e] font-semibold hover:brightness-110">
              Falar no WhatsApp
            </a>
          </div>
        </div>
